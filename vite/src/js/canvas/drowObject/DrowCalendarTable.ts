...
export default class DrowCalendarTable extends DrowSimpleTable {
    ...
    public getYPos(row:number, style:DrowSimpleTable.YStyle):number{
        let yHeight:number = this.tableParam.cellSize.height;
        let yPos = row * yHeight;
        let result:number;
