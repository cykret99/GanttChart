...
export default class DrowButtonBase extends DrowContainerBase {
    ...
    constructor(label: string, color?: string, bgcolor?:string, width?:number, height?:number, radius?:number) {
        super();
        let THIS = this;
        // ロールオーバーイベントを登録
    ...
    public repaint() {
        ...
        this.labelObj.setAlign(DrowTextBase.Align.CENTER);
        this.labelObj.setBaseline(DrowTextBase.Baseline.MIDDLE);
